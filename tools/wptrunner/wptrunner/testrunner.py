...
def make_test_queue(tests, test_source):
    queue = test_source.cls.make_queue(tests, **test_source.kwargs)
...
class ManagerGroup:
    ...
    def __init__(self, suite_name, size, test_source, test_implementations,
                 rerun=1,
    ...
    def run(self, tests):
        ...
        test_queue = make_test_queue(tests, self.test_source)
